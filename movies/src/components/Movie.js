    ...
    <div className="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#latest-movies">
              Latest Release
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#upcoming-movies">
              Upcoming Movies
            </a>
          </li>
          <li class="nav-item">
        ...
        <Link to="/" class="btn btn-outline-danger" type="submit">
          LOGOUT
        </Link>
      </div>
    </div>
  ...
  >
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="./images/jailer.jpg" class="d-block w-100" alt="..." />
        
      </div>
      <div class="carousel-item">
        <img src="./images/jawan.jpg" class="d-block w-100" alt="..." />
      </div>
      <div class="carousel-item">
        <img src="./images/3ekka.jpg" class="d-block w-100" alt="..." />
      </div>
    </div>
    <button
